...
## Algorithm
1. Collect house dataset with features and target values.
2.Train the SGD Regressor model using training data.
3.Give new house details as input.
4.Predict house price and number of occupants.
